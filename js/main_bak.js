    ...
    function showDetails(data, status){
		if(status != "success"){
			...
			if(typeof data["facets"] != 'undefined'){
				...
				metaContent.innerHTML = "Original data layer is in <b>" + fileFormat + "</b> format and in projection <b>" + epsg + "</b>.";
				...
				*/
				...
				dbutton.innerHTML = "Download Directly";
...
function reproject_download(){
	...
	jQuery.ajax(
	{
		...
		success: function(){
			...
			rdownloadLink.innerHTML = "Save<br>";
